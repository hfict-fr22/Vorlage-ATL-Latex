...
\documentclass[
    ...
    onehalfspacing,             % Abstandsoption: singlespacing, onehalfspacing or doublespacing (einfacher Abstand, halber Abstand oder doppelter Abstand)
...
%----------------------------------------------------------------------------------------
\include{Vorderteil/erklaerungATL}
